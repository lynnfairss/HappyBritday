...
import com.example.happybritday.ui.theme.HappyBritdayTheme
import com.example.happybritday.R
...
fun GreetingImage(message: String, from: String) {
    val image = painterResource(id = R.drawable.ronaldo) // Gambar latar
...
fun BirthdayCardPreview() {
    HappyBritdayTheme  {
        GreetingImage(message = "Happy Birthday Cristiano!", from = "From lyan")
    }
}